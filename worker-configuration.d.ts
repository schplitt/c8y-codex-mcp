/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: deaae64343ce8e5d19149284b4970e01)
// Runtime types generated with workerd@1.20260219.0 2026-02-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server/index");
		durableNamespaces: "CodexMcpAgent";
	}
	interface Env {
		CACHE: KVNamespace;
		BROWSER: Fetcher;
		MCP_OBJECT: DurableObjectNamespace<import("./server/index").CodexMcpAgent>;
	}
}
